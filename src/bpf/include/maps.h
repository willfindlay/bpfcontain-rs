...
#define BPF_LRU_HASH(NAME, KEY, VALUE, SIZE, PIN, FLAGS)                       \
    struct {                                                                   \
 ...
 * and
 * @SIZE max entries. The map creation flags may be specified with @FLAGS. */
#define BPF_PERCPU_HASH(NAME, KEY, VALUE, SIZE, PIN, FLAGS)                    \
    struct {                                                                   \
 ...
 * @FLAGS. */
#define BPF_LRU_PERCPU_HASH(NAME, KEY, VALUE, SIZE, PIN, FLAGS)                \
    struct {                                                                   \
...
#define BPF_ARRAY(NAME, VALUE, SIZE, PIN, FLAGS)                               \
    struct {                                                                   \
...
#define BPF_PERCPU_ARRAY(NAME, VALUE, SIZE, PIN, FLAGS)                        \
    struct {                                                                   \
...
#define BPF_CGROUP_ARRAY(NAME, SIZE, PIN, FLAGS)                               \
    struct {                                                                   \
 ...
 * The map creation flags may be specified with @FLAGS. */
#define BPF_STACK(NAME, VALUE, SIZE, PIN, FLAGS)                               \
    struct {                                                                   \
 ...
 * The map creation flags may be specified with @FLAGS. */
#define BPF_QUEUE(NAME, VALUE, SIZE, PIN, FLAGS)                               \
    struct {                                                                   \
 ...
 * The map creation flags may be specified with @FLAGS. */
#define BPF_INODE_STORAGE(NAME, VALUE, PIN, FLAGS)                             \
    struct {                                                                   \
